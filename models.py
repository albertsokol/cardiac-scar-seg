...
class UNet3D(SegModel):
    ...
    def up_conv_block(self, m, prev, filters_a, filters_b):
        ...
        m = layers.Conv3DTranspose(filters_a, self.conv3d_transpose_kernel_size, strides=(2, 2, 2), padding='same',
                                   activation='relu')(m)
        m = layers.BatchNormalization()(m)
...
def build_unet_plus_plus(model_input, filters, kernel_size, l):
    ...
    # TODO: need to add residual connections !! As per V-Net. U-Net 3D, I'm not so sure ...
