...
class PerformanceFinder:
    ...
    def find_mean_dice(self, classifier_threshold=0.5):
        ...
        for i in tqdm(range(self.steps)):
            ...
            # Generate the ground truth segmentation for this _img-ray
...
if __name__ == '__main__':
    ...
    pf = PerformanceFinder(csv_path='/home/y4tsu/Desktop/data/siim/train-rle.csv',
                           fpath='/home/y4tsu/Desktop/data/siim/dicom_train/',
    ...
    dice = pf.find_mean_dice()
    print(f'dice found: {dice}')
