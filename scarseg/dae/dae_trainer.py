...
class DAETrainer:
    ...
    def __init__(
        ...
        # Labels
        self.labels = labels
        self.loss_fn = WeightedSoftmaxLoss(batch_size, image_size, self.calculate_label_weights())
    ...
    def calculate_label_weights(self):
        ...
        print(f'Calculating label weightings across {len(self.train_gen.in_fnames)} label images for use in loss'
        ...
        total_voxels = np.prod(np.array([*self.image_size, len(self.train_gen.in_fnames)]))
